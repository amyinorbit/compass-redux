//===--------------------------------------------------------------------------------------------===
// inst.x.h - x-macro bytecode data
//
...
//===--------------------------------------------------------------------------------------------===
#ifndef OPCODE
#define OPCODE(name, val, op, stack)
#define ___NOOP_OPCODE___
#endif
...
OPCODE(invalid   , 0x27,  +0,  -1) 

#ifdef ___NOOP_OPCODE___
#undef OPCODE
#undef ___NOOP_OPCODE___
#endif
